...
EXPOSE 18001
ENV JAVA_OPTS=""
CMD java $JAVA_OPTS -Dspring.application.json="{\"app\":{\"client\":\"covid\"}}" -Dspring.profiles.active=local -Dspring.config.location=file:/opt/resources/$ENV_FILE_NAME -Djava.security.egd=file:/dev/./urandom -jar /jar/*
